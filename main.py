...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
	...
	reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("Dᴇᴠᴇʟᴏᴘᴇʀ", url="https://github.com/amitpatle")]]), reply_to_message_id=message.id)
...
ꜰᴏʀ ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛꜱ
```
ꜰɪʀꜱᴛ ꜱᴇɴᴅ ɪɴᴠɪᴛᴇ ʟɪɴᴋ ᴏꜰ ᴛʜᴇ ᴛʜᴇɴ ꜱᴇɴᴅ ᴘᴏꜱᴛ/ꜱ ʟɪɴᴋ

```
ꜰᴏʀ ʙᴏᴛ ᴄʜᴀᴛꜱ
```
ʜᴛᴛᴘꜱ://ᴛ.ᴍᴇ/ʙ/ʙᴏᴛᴜꜱᴇʀɴᴀᴍᴇ/4321
